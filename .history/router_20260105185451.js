...
const Router = {
  ...
  render() {
    ...
    const view = views[this.currentRoute] || views['home'];
  ...
  loadSettings() {
    ...
    document.getElementById('settingsUserName').textContent = user?.name || 'Không có tên';
    document.getElementById('settingsUserEmail').textContent = user?.email || 'Không có email';
  },
